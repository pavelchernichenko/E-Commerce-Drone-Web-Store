<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="ItemDetailPage.aspx.cs" Inherits="ItemDetailPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <form class="form-inline" runat="server" id="form">
        ...
        <div class="container">
            <select class="selectpicker" data-dropup-auto="false" runat="server" id="quantityDropDown" data-style="btn-outline-primary"></select>
