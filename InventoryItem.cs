...
public class InventoryItem
{
    ...
    public string ToHTML(bool detailedView)
    {
        ...
        html = "<div style ='border-color:royalblue; border-style:solid; border-radius: 8px; border-width:4px; padding:0px; margin:0px;' class='col-md-4 col-md-6 mb-4'>";
        html = "<div style ='class='col-md-4 col-md-6 mb-4'>";
        html += "<div class='card h-100'>";
